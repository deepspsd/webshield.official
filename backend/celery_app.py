...
celery_app.conf.task_routes = {
    ...
    "backend.celery_tasks.scan_url_task": {"queue": "scans_high", "priority": 9, "routing_key": "scans.high"},
    # Bulk scanning with medium priority
    "backend.celery_tasks.bulk_scan_task": {"queue": "scans_bulk", "priority": 5, "routing_key": "scans.bulk"},
