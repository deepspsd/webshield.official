...
def main():
    ...
    parser.add_argument('dataset_path', nargs='?', default='malicious_phish.csv',
                        help='Path to the malicious_phish.csv dataset')
    parser.add_argument('--max-samples', type=int, default=None,
                        help='Limit number of samples (e.g., 100000 for testing)')
    parser.add_argument('--enhanced', action='store_true',
                        help='Enable enhanced model training with hyperparameter tuning (slower)')
