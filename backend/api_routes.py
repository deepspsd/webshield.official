...
_health_cache = {
    "ml_status": None,
    "ml_status_time": 0,
    "cache_ttl": 60  # Cache ML status for 60 seconds
}
...
def health_check():
    ...
    if (current_time - float(_health_cache.get("db_last_check", 0) or 0)) > 15 and not _health_cache.get("db_check_inflight", False):
