...
class WebShieldMonitor:
    def __init__(self):
        ...
        self.max_memory_mb = 512  # 512MB max memory usage
        self.max_cpu_percent = 80  # 80% max CPU usage
    ...
    def check_system_resources(self):
        ...
        try:
            ...
            logger.info(f"System Status - CPU: {cpu_percent:.1f}%, Memory: {memory_mb:.1f}MB, Disk: {disk_percent:.1f}%")
